...
@endsection
    ...
    <script src="{{asset('cms/assets/vendor/datatables.net-bs5/js/dataTables.bootstrap5.min.js')}}"></script>
     ...
     <!-- Jobs DataTable Initialization -->
      <script>
            $('#service-report-datatable').DataTable({
              processing: true,
              serverSide: true,
              language: {
                  paginate: {
              ...
              ajax: '{{ route('service-reports.data') }}',
              columns: [
                      { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                      { data: 'job_id', name: 'job_id' },                // ← FIXED
                      { data: 'task_details', name: 'task_details' },    // ← FIXED
                      { data: 'technician_name', name: 'technician_name' }, // ← FIXED
